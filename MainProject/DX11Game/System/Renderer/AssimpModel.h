...
public:
	...
	void Draw(ID3D11DeviceContext* pDC, DirectX::XMFLOAT4X4& mtxWorld,SHADER_BONE bone, EByOpacity byOpacity = eNoAffect);
	void Release();

	SHADER_BONE SetBoneMatrix(ID3D11DeviceContext* pDC, XMFLOAT4X4 mtxBone[]);
