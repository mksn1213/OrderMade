...
void CSprout::OnCreate()
{
	...
	renderer->SetModel(EModelType::Sprout_W);
	...
	uiCom->SetIconTexture(ETexture::Icon_Sprout);
...
*/
void CSprout::OnCollision(std::weak_ptr<CCollider> collider)
{
...
* @return	bool			アクション有無
*/
bool CSprout::ExistsProcess(std::weak_ptr<CCollider> collider)
{
	// 相手オブジェクトによって処理が変わる
...
* @return	bool			処理の有無
*/
bool CSprout::ExistsProcess(std::weak_ptr<CCollider> collider, std::weak_ptr<CGameObject> itemObj)
{
	// 持っているアイテムによって処理を変える
...
* @param	color		色情報
*/
void CSprout::SetColor(CColor color)
{
	// 色のセット
	m_eColor = color;
	...
	{
	case CColor::EColor::White:		renderer->SetModel(EModelType::Sprout_W);	break;
	case CColor::EColor::Cyan:		renderer->SetModel(EModelType::Sprout_C);	break;
	case CColor::EColor::Magenta:	renderer->SetModel(EModelType::Sprout_M);	break;
	case CColor::EColor::Yellow:	renderer->SetModel(EModelType::Sprout_Y);	break;
	case CColor::EColor::Red:		renderer->SetModel(EModelType::Sprout_R);	break;
	case CColor::EColor::Green:		renderer->SetModel(EModelType::Sprout_G);	break;
	case CColor::EColor::Blue:		renderer->SetModel(EModelType::Sprout_B);	break;
	default:																	break;
	}
